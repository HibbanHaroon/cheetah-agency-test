...
function Textfield() {
  return (
    <div className="relative mt-1 rounded-md shadow-sm mt-7">
      <input
        type="text"
      ...
      />
      <div className="m-1 absolute inset-y-0 end-0 flex items-center px-1 bg-primary-light rounded-md cursor-pointer hover:bg-primary-dark">
        <PlusIcon></PlusIcon>
      </div>
    </div>
  );
